  ...
  <div className="w-full h-screen duration-200"
    ...
    justify-center bottom-12 inset-x-0 px-2">
      ...
      gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
        ...
        className="outline-none px-4 py-1
        rounded-full text-white shadow-lg"
        style={{ fontWeight:"bold",backgroundColor:"olive" }}>
        Olive</button>
        ...
        className="outline-none px-4 py-1
        rounded-full text-white shadow-lg"
        style={{ fontWeight:"bold",backgroundColor:"grey" }}>
        Grey</button>
        ...
        className="outline-none px-4 py-1
        rounded-full text-white shadow-lg"
        style={{fontWeight:"bold",color:"black",backgroundColor:"pink" }}>
        Pink</button>
        ...
        className="outline-none px-4 py-1
        rounded-full text-white shadow-lg"
        style={{ fontWeight:"bold",color:"black",backgroundColor:"lavender" }}>
        Lavender</button>
